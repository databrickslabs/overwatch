  ...
  private val requiredSchemas: Map[Int, StructType] = Map(
    ...
    2006 -> StructType(Seq(
      ...
      StructField("Properties",
        StructType(Seq(
          StructField("sparkappname", StringType, nullable = true),
          StructField("sparkdatabricksapiurl", StringType, nullable = true),
          StructField("sparkjobGroupid", StringType, nullable = true),
          StructField("sparkdatabrickscloudProvider", StringType, nullable = true),
          StructField("sparkdatabricksclusterSource", StringType, nullable = true),
          StructField("sparkdatabricksclusterUsageTagsautoTerminationMinutes", StringType, nullable = true),
          StructField("sparkdatabricksclusterUsageTagsclusterAllTags", StringType, nullable = true),
          StructField("sparkdatabricksclusterUsageTagsclusterAvailability", StringType, nullable = true),
          StructField("sparkdatabricksclusterUsageTagsclusterId", StringType, nullable = true),
          StructField("sparkdatabricksclusterUsageTagsclusterInstancePoolId", StringType, nullable = true),
          StructField("sparkdatabricksclusterUsageTagsclusterMaxWorkers", StringType, nullable = true),
          StructField("sparkdatabricksclusterUsageTagsclusterMinWorkers", StringType, nullable = true),
          StructField("sparkdatabricksclusterUsageTagsclusterName", StringType, nullable = true),
          StructField("sparkdatabricksclusterUsageTagsclusterOwnerUserId", StringType, nullable = true),
          StructField("sparkdatabricksclusterUsageTagsclusterScalingType", StringType, nullable = true),
          StructField("sparkdatabricksclusterUsageTagsclusterSpotBidPricePercent", StringType, nullable = true),
          StructField("sparkdatabricksclusterUsageTagsclusterTargetWorkers", StringType, nullable = true),
          StructField("sparkdatabricksclusterUsageTagsclusterWorkers", StringType, nullable = true),
          StructField("sparkdatabricksclusterUsageTagscontainerZoneId", StringType, nullable = true),
          StructField("sparkdatabricksclusterUsageTagsdataPlaneRegion", StringType, nullable = true),
          StructField("sparkdatabricksclusterUsageTagsdriverNodeType", StringType, nullable = true),
          StructField("sparkdatabricksworkerNodeTypeId", StringType, nullable = true),
          StructField("sparkdatabricksclusterUsageTagssparkVersion", StringType, nullable = true),
          StructField("sparkdatabricksnotebookid", StringType, nullable = true),
          StructField("sparkdatabricksnotebookpath", StringType, nullable = true),
          StructField("sparkdatabrickssparkContextId", StringType, nullable = true),
          StructField("sparkdriverhost", StringType, nullable = true),
          StructField("sparkdrivermaxResultSize", StringType, nullable = true),
          StructField("sparkexecutorid", StringType, nullable = true),
          StructField("sparkexecutormemory", StringType, nullable = true),
          StructField("sparksqlexecutionid", StringType, nullable = true),
          StructField("sparksqlexecutionparent", StringType, nullable = true),
          StructField("sparksqlshufflepartitions", StringType, nullable = true),
