 ...
 * @param config
 */
class InitializerDeprecated(config: Config) extends SparkSessionWrapper {
...
object InitializerDeprecated extends SparkSessionWrapper {
  ...
  private[overwatch] def apply(
    ...
    val initializer = new InitializerDeprecated(config)
      .setIsSnap(isSnap)
