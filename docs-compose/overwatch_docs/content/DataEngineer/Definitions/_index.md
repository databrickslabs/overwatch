...
| warehouse_spec_silver          | DBSQL            | silver  | Slow changing dimension used to track all warehouse through time including edits but **excluding state change**.                                                                                                                                                |
| warehouse_state_detail_silver  | warehouseEvents  | silver  | State detail for each warehouse event enriched with cost information                                                                                                                                                                                            |
...
| warehousestatefact_gold  | warehouseEvents                    | gold  | All warehouse event changes along with the time spent in each state and the core hours in each state. This table should be used to find warehouse anomalies and/or calculate compute/DBU costs of some given scope.                                                                                                                                                                |