...
![AzureClusterLogging](/images/EnvironmentSetup/Azure/Cluster_Logs_Azure.png)

## Reference Architecture
| Basic Deployment       | Multi-Region Deployment |
| ---------------------- | ----------------------  |
| ![BasicAzureArch](/images/EnvironmentSetup/Azure/Overwatch_Arch_Simple_Azure.png)| ![AzureArch](/images/EnvironmentSetup/Azure/Overwatch_Arch_Azure.png)|
...
![sas1](/images/EnvironmentSetup/Azure/sas1.png)
![sas2](/images/EnvironmentSetup/Azure/sas2.png)
![sas3](/images/EnvironmentSetup/Azure/sas3.png)
...
![Named_EH_Visual](/images/EnvironmentSetup/Azure/Azure_EH_Example.png) ![EH_Validation](/images/EnvironmentSetup/Azure/EH_Validation.png)
...
![EH_Base_Setup](/images/EnvironmentSetup/Azure/EH_BaseConfig.png)
...
the the image below.
![Storage Overview](/images/EnvironmentSetup/Azure/storage_acc_7.png)
### Step 1
Select Storage Account from your Azure Portal and hit create
### Step 2
Enter your Subscription and Resource Group in Basics Tab
![storage1](/images/EnvironmentSetup/Azure/storage_acc_1.png)
...
![storage2](/images/EnvironmentSetup/Azure/storage_acc_2.png)
### Step 3
**Recommendations**
...
![storage3](/images/EnvironmentSetup/Azure/storage_acc_3.png)
![storage4](/images/EnvironmentSetup/Azure/storage_acc_4.png)
### Step 4
...
![storage5](/images/EnvironmentSetup/Azure/storage_acc_5.png)
### Step 5
Add relevant tags and create
![storage6](/images/EnvironmentSetup/Azure/storage_acc_6.png)
