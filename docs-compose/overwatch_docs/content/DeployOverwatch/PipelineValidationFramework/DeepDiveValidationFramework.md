...
| tableArray           | String  | Yes      | Array()       | Array of tables on which Single Table Validation need to be performed       |
| crossTableValidation | Boolean | Yes      | Yes           | Boolean flag act as on and off switch for cross table validation            |
